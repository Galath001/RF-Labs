<ADSWorkspace Revision="2" Version="100">
    <Workspace Name="">
        ...
        <Cell Name="Rogers_4_lib:matckt_lab" />
        <Cell Name="Rogers_4_lib:matckta" />
        <Cell Name="Rogers_4_lib:matcktb" />
        <Cell Name="Rogers_4_lib:matcktc" />
        <Cell Name="Rogers_4_lib:matcktd" />
        <Cell Name="Rogers_4_lib:matckte" />
        <Data_Display Name="matckt_lab.dds" />
        <Dataset Name="matckt_lab.ds" />
        <Log Name="netlist.log" />
        <Log Name="search_history.log" />
        <Log Name="writegbr.log" />
        <Preferences Name="layout.prf" />
        <Preferences Name="Rogers_4_lib_lay.prf" />
        <Preferences Name="schematic.prf" />
        <LibraryDefs Name="lib.defs" />
        <ConfigFile Name="de_sim.cfg" />
        <ConfigFile Name="hpeesofsim.cfg" />
        <ConfigFile Name="linecalc.cfg" />
        <Cell Name="Rogers_4_lib:matdat" />
    </Workspace>
</ADSWorkspace>
